...
GF_Holster_Disable_Throw 					= false;




if (GF_Holster_systemchat_info) then{
systemchat "shift+H to holster weapon";			
};	

if (GF_Holster_diag_log_info) then{
diag_log "Holster script loading...";
};
...
if (GF_Holster_systemchat_info) then{
systemchat "Holster Script - Mod initialized";
systemchat "H o l s t e r    y o u r    W e a p o n    w i t h    k e y    5";			
};	

if (GF_Holster_diag_log_info) then{
diag_log "//________________   Holster Script - Mod initialized	________________";
};