...
[
	"Connect to the aussiearma gaming discord at www.aussiearma.com",
	"Server news, comp claims and more join the communnity www.aussiearma.com",
	...
	"Listen to Me First & the Gimme Gimmes",
	"Pat a cat today",
	"Keegan has got the tism"
];
